...
import huminityIcon from './assets/huminityIcon.jpg'
    ...
    <>
      ...
      <div className="data-container">
        <div className="element">
          <img src= {huminityIcon} alt="huminity" width={20} className='icon'/>
          <div className="data">
            <div className="huminity-percent"> {huminity} %</div>
            <div className="text">Humidity</div>
          </div>
        </div>
        <div className="element">
          <img src= {windIcon} alt="wind" width={20} className='icon'/>
          <div className="data">
...
function App() {
  let api_key="d0ebf22b72f8688c47fec1af7e3650b3";
